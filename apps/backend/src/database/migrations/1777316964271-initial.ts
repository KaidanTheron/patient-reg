...
export class Initial1777316964271 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "patient_identities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "identity" character varying NOT NULL, "email" text NOT NULL, "phone" text NOT NULL, "firstname" text, "lastname" text, CONSTRAINT "UQ_f6579f372450f38bb06d001cda1" UNIQUE ("identity"), CONSTRAINT "PK_5b40aeddb0d56cc3630eb2bca01" PRIMARY KEY ("id"))`);
