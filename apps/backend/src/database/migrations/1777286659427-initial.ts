...
export class Initial1777286659427 implements MigrationInterface {
    name = 'Initial1777286659427'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "patient_identities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "identity" character varying NOT NULL, "email" text NOT NULL, "phone" text NOT NULL, "fullName" text, CONSTRAINT "UQ_f6579f372450f38bb06d001cda1" UNIQUE ("identity"), CONSTRAINT "PK_5b40aeddb0d56cc3630eb2bca01" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "registration_documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" text NOT NULL, "phoneNumber" text NOT NULL, "residentialAddress" text NOT NULL, "fullName" text, "dateOfBirth" text, "submittedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "registrationRequestId" uuid, "patientIdentityId" character varying NOT NULL, CONSTRAINT "REL_7b86292a3eb0c73381335357b7" UNIQUE ("registrationRequestId"), CONSTRAINT "PK_b7c0d11b37eb60171a8304833ef" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "patient_records" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" text, "phoneNumber" text, "residentialAddress" text, "fullName" text, "dateOfBirth" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "patientIdentityId" character varying NOT NULL, CONSTRAINT "PK_146301514bbccff6c5138b36db4" PRIMARY KEY ("id"))`);
