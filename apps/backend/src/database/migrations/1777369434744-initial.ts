...
export class Initial1777369434744 implements MigrationInterface {
    name = 'Initial1777369434744'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "patient_identities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "identity" character varying NOT NULL, "email" text, "phone" text, "firstname" text NOT NULL, "lastname" text NOT NULL, CONSTRAINT "UQ_f6579f372450f38bb06d001cda1" UNIQUE ("identity"), CONSTRAINT "PK_5b40aeddb0d56cc3630eb2bca01" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "registration_documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" text, "phoneNumber" text, "altphone" text, "residentialAddress" text, "firstname" text, "lastname" text, "dateOfBirth" text, "gender" text, "scheme" text, "memberNumber" text, "mainMember" text, "mainMemberId" text, "dependantCode" text, "allergies" text, "currentMedication" text, "chronicConditions" text, "previousSurgeries" text, "familyHistory" text, "submittedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "registrationRequestId" uuid, "patientIdentityId" character varying NOT NULL, CONSTRAINT "REL_7b86292a3eb0c73381335357b7" UNIQUE ("registrationRequestId"), CONSTRAINT "PK_b7c0d11b37eb60171a8304833ef" PRIMARY KEY ("id"))`);
